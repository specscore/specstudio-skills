...
- **Notification surface.** Phase 3 hook drains the queue; how does the user *learn* a verdict is ready without polling? event → terminal message? PushNotification? Out of MVP, but design space worth naming.
