...
- **Existing Features affected:**
  ...
  - `synchestra:whats-next` (in `orchestrator` repo) — extends to surface `consilium-review` tasks and seeds with `needs-human-review` verdicts at the top of the prioritization report.
