...
- **Dependencies:**
  ...
  - `proposals-and-feature-phases` Idea (Draft, specscore repo) — the skill routes proposals to `spec/features/<feature>/proposals/`. Until the proposal spec ships, proposals degrade to Ideas with "proposed change to Feature X" framing.
