...
Rehearse stub for AC `rejection-reason-outside-rejected-rejected` from `spec/features/issue-artifact-type/README.md`. See the AC's Given/When/Then in the Feature README for the fixture-tree shape and expected lint output.
