...
Rehearse stub for AC `duplicated-required-h2-section-rejected` from `spec/features/issue-artifact-type/README.md`. See the AC's Given/When/Then in the Feature README for the fixture-tree shape and expected lint output.
