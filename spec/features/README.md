...
| [seed-to-idea-promotion](seed-to-idea-promotion/README.md) | Under Review | Promote a sidekick seed into a lint-clean Idea via a deterministic specscore idea promote verb (same-repo git mv + body transform + back-link reconcile; cross-repo keep+promoted), with a skill-side consilium-offer handshake for unreviewed manually-picked seeds. |
