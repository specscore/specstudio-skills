...
Invoke with a valid one-liner and `--body` content that pushes the total body length to 3001 chars; assert non-zero exit with the 3000-char body message; assert no file or event change.
